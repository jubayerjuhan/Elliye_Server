...
const { getAllproducts, createProduct, updateProduct, deleteProduct, getSingleProduct, addRating, getAllReviews, deleteReview } = require('../Controllers/productcontroller.js');
